...
def generate_comparison(workspace_root: Path, block_name: str, v1_name: str, v2_name: str, config: dict) -> bool:
    ...
    header_height = 100
    total_width = res * 2
    # We will create a grid: 2 columns, 2 rows + 1 row for titles
    total_height = header_height + (res * 2)
    ...
    for i, view in enumerate(views):
        ...
        draw.text((res, y_offset + res // 2), view.title(), fill="white", font=font, anchor="mm")
